<?php
/**
 * Por como está diseñado PHPWord, no es posible añadir decimales al gráfico circular sin tocar el código de la clase
 * que lo genera. Para evitar tocar archivos de vendor, redefino esta clase aquí (ver composer.json).
 */
